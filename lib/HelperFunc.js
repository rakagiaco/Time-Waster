...
function createLootInterfaceWindow(item, contextScene){
    ...
    closeBTN = contextScene.add.text(contextScene.cameras.main.scrollX + contextScene.cameras.main.width/2-120, contextScene.cameras.main.scrollY + contextScene.cameras.main.height/2-120, "exit", {font: '14px Arial', fill: '#FFFFFF', })
