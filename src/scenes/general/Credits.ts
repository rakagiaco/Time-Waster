...
export class Credits extends Phaser.Scene {
    ...
    create(): void {
        ...
        this.add.bitmapText((this.game.config.width as number) / 2, (this.game.config.height as number) / 2 - 50, '8-bit-white', 'Developed by Donnie Derx and Rakamini `hentiai` Giaconui', 32).setOrigin(0.5);
        this.add.bitmapText((this.game.config.width as number) / 2, (this.game.config.height as number) / 2, '8-bit-white', 'and a clanker', 32).setOrigin(0.5);
